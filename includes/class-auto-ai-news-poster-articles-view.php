                        ...
                        <div id="post-body" class="metabox-holder columns-2">
                            ...
                            <div id="post-body-content">
                                ...
                                <div class="postbox">
                                    ...
                                    <input type="text" id="title" name="post_title" class="form-control widefat" placeholder="Titlul comun al știrii" />
                                </div>

                                <!-- Conținutul articolului -->
                                <div class="postbox">
                                    <label for="content" class="screen-reader-text">Conținutul articolului</label>
                                    <textarea id="content" name="post_content" rows="10" class="form-control widefat" placeholder="Conținutul obiectiv al știrii din minim trei surse."></textarea>
                                </div>
                            </div>

                            <!-- Sidebar dreapta cu categoriile și butoanele -->
                            <div id="postbox-container-1" class="postbox-container">
                                ...
                                <div class="postbox">
                                    <h2>Etichete</h2>
                                    <div class="inside">
                                        <input type="text" name="tags" class="form-control widefat" placeholder="Adaugă etichete separate prin virgulă">
                                    </div>
                                </div>
