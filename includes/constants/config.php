...
function generate_prompt($sources, $additional_instructions, $tags): string
{
    ...
    $prompt .= "3. Generează numele categoriei (category).\n";
    $prompt .= "4. Dacă găsești imagini relevante în articolele sursă, parsează, codul sursa html si extrage valoarea 'src' din elementul 'img', apoi listează URL-urile imaginilor pentru a le include în articol (images).\n";
